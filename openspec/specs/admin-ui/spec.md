...
Courier SHALL embed a deterministic Lit administration application built from the shared UI kit with typed English and Russian catalogs, system/light/dark themes, keyboard-operable actions, responsive layout, and visible conflict/error states.
