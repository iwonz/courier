...
`,Ce=class extends W{constructor(...e){super(...e),this.disabled=!1,this.type=`button`,this.variant=`secondary`}static{this.properties={disabled:{type:Boolean,reflect:!0},type:{type:String,reflect:!0},variant:{type:String,reflect:!0}}}static{this.styles=[xe,o`
  ...
  `}change(e){this.checked=e.currentTarget.checked,this.dispatchEvent(new CustomEvent(`courier-checkbox-change`,{detail:this.checked,bubbles:!0,composed:!0}))}render(){return F`<label>
    ...
    </label>`}},q={en:{"theme.label":`Theme`,"theme.system":`System`,"theme.light":`Light`,"theme.dark":`Dark`,"locale.label":`Language`,"locale.en":`English`,"locale.ru":`Russian`,"progress.label":`Delivery progress`,"action.cancel":`Cancel`,"action.close":`Close`},ru:{"theme.label":`Тема`,"theme.system":`Системная`,"theme.light":`Светлая`,"theme.dark":`Тёмная`,"locale.label":`Язык`,"locale.en":`Английский`,"locale.ru":`Русский`,"progress.label":`Ход доставки`,"action.cancel":`Отмена`,"action.close":`Закрыть`}},Ye=Object.keys(q),J=`courier.locale`;function Y(e){if(!e)return;let t=e.toLowerCase().split(`-`)[0];return Ye.includes(t)?t:void 0}function Xe(e){for(let t of e){let e=Y(t);if(e)return e}return`en`}function Ze(e,t){if(e)try{let t=Y(e.getItem(J));if(t)return t}catch{}return Xe(t)}function Qe(e,t){if(e)try{e.setItem(J,t)}catch{}}function X(e,t){return q[Y(e)??`en`][t]}function $e(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.navigator?.languages??[];return Ze(e,t)}var et=class extends W{constructor(...e){super(...e),this.locale=`en`}static{this.properties={locale:{type:String}}}connectedCallback(){super.connectedCallback(),this.locale=$e()}change(e){let t=Y(e.detail)??`en`;this.locale=t;let n;try{n=globalThis.localStorage}catch{n=void 0}Qe(n,t),this.dispatchEvent(new CustomEvent(`courier-locale-change`,{detail:t,bubbles:!0,composed:!0}))}render(){return F`<courier-segmented-control
      icon-only
    ...
    ></courier-segmented-control>`}},tt=class extends W{constructor(...e){super(...e),this.heading=``}static{this.properties={heading:{type:String}}}static{this.styles=o`
    :host {
      display: block;
      overflow: hidden;
      border: 1px solid var(--courier-color-border, #c8cdbf);
  ...
  `}render(){return this.heading?F`<section aria-labelledby="courier-panel-heading">
      ...
      <slot></slot>
    </section>`:F`<section><slot></slot></section>`}};function nt(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.min(1,Math.max(0,e/t))}var rt=class extends W{constructor(...e){super(...e),this.value=0,this.total=0,this.label=``,this.locale=`en`}static{this.properties={value:{type:Number},total:{type:Number},label:{type:String},locale:{type:String}}}static{this.styles=o`
    :host {
      display: grid;
  ...
  `}render(){let e=nt(this.value,this.total),t=this.label||X(this.locale,`progress.label`),n=Number.isFinite(this.total)&&this.total>0?this.total:0;return F`<div
      class="track"
      role="progressbar"
      aria-label=${t}
      aria-valuemin="0"
    ...
    <output>${Math.round(e*100)}%</output>`}};function it(e,t,n){if(!(n<=0))switch(e){case`ArrowLeft`:case`ArrowUp`:return(t-1+n)%n;case`ArrowRight`:case`ArrowDown`:return(t+1)%n;case`Home`:return 0;case`End`:return n-1;default:return}}var at=class extends W{constructor(...e){super(...e),this.label=``,this.options=[],this.value=``,this.iconOnly=!1}static{this.properties={label:{type:String},options:{attribute:!1},value:{type:String},iconOnly:{type:Boolean,attribute:`icon-only`,reflect:!0}}}static{this.styles=o`
