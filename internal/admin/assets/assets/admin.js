...
`,ye=class extends J{constructor(...e){super(...e),this.disabled=!1,this.type=`button`,this.variant=`secondary`}static{this.properties={disabled:{type:Boolean,reflect:!0},type:{type:String,reflect:!0},variant:{type:String,reflect:!0}}}static{this.styles=[_e,o`
  ...
  `]}render(){return L`<button type=${this.type} ?disabled=${this.disabled}><slot></slot></button>`}},be=`/assets/admin.png`,xe=class extends J{constructor(...e){super(...e),this.product=``}static{this.properties={product:{type:String}}}static{this.styles=o`
  ...
  `}render(){return L`<span class="lockup">
    ...
    </span>`}},Se=class extends J{constructor(...e){super(...e),this.alt=``,this.eager=!1,this.mobileSource=``,this.source=``}static{this.properties={alt:{type:String},eager:{type:Boolean},mobileSource:{type:String,attribute:`mobile-source`},source:{type:String}}}static{this.styles=o`
    :host { display: block; }
    picture { display: contents; }
    img { display: block; width: 100%; height: auto; filter: drop-shadow(0 1.5rem 2rem rgb(16 18 15 / 0.18)); }
  `}render(){return L`<picture>${this.mobileSource?L`<source media="(max-width: 44rem)" srcset=${this.mobileSource}>`:``}<img part="image" src=${this.source} alt=${this.alt} decoding="async" loading=${this.eager?`eager`:`lazy`} fetchpriority=${this.eager?`high`:`auto`}></picture>`}},Ce=class extends J{constructor(...e){super(...e),this.tone=`neutral`}static{this.properties={tone:{type:String,reflect:!0}}}static{this.styles=o`
    :host {
      display: inline-flex;
      width: max-content;
      align-items: center;
  ...
  `}render(){return L`<i aria-hidden="true"></i><slot></slot>`}},we=class extends J{constructor(...e){super(...e),this.source=``,this.destination=``}static{this.properties={source:{type:String},destination:{type:String}}}static{this.styles=o`
  ...
  `}render(){return L`<div class="route"><span class="node">${this.source}</span><span class="line" aria-hidden="true"></span><span class="node">${this.destination}</span></div>`}},Te={en:{"theme.label":`Theme`,"theme.system":`System`,"theme.light":`Light`,"theme.dark":`Dark`,"locale.label":`Language`,"locale.en":`English`,"locale.ru":`Russian`,"progress.label":`Delivery progress`,"action.cancel":`Cancel`,"action.close":`Close`},ru:{"theme.label":`Тема`,"theme.system":`Системная`,"theme.light":`Светлая`,"theme.dark":`Тёмная`,"locale.label":`Язык`,"locale.en":`Английский`,"locale.ru":`Русский`,"progress.label":`Ход доставки`,"action.cancel":`Отмена`,"action.close":`Закрыть`}},Ee=Object.keys(Te),Y=`courier.locale`;function X(e){if(!e)return;let t=e.toLowerCase().split(`-`)[0];return Ee.includes(t)?t:void 0}function De(e){for(let t of e){let e=X(t);if(e)return e}return`en`}function Oe(e,t){if(e)try{let t=X(e.getItem(Y));if(t)return t}catch{}return De(t)}function ke(e,t){if(e)try{e.setItem(Y,t)}catch{}}function Z(e,t){return Te[X(e)??`en`][t]}function Ae(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.navigator?.languages??[];return Oe(e,t)}var je=class extends J{constructor(...e){super(...e),this.locale=`en`}static{this.properties={locale:{type:String}}}connectedCallback(){super.connectedCallback(),this.locale=Ae()}change(e){let t=X(e.detail)??`en`;this.locale=t;let n;try{n=globalThis.localStorage}catch{n=void 0}ke(n,t),this.dispatchEvent(new CustomEvent(`courier-locale-change`,{detail:t,bubbles:!0,composed:!0}))}render(){return L`<courier-segmented-control
      icon-only
    ...
    ></courier-segmented-control>`}},Me=class extends J{constructor(...e){super(...e),this.heading=``}static{this.properties={heading:{type:String}}}static{this.styles=o`
    :host {
      display: block;
      overflow: hidden;
      border: 1px solid var(--courier-color-border, #c8cdbf);
  ...
  `}render(){return this.heading?L`<section aria-labelledby="courier-panel-heading">
      ...
      <slot></slot>
    </section>`:L`<section><slot></slot></section>`}};function Ne(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.min(1,Math.max(0,e/t))}var Pe=class extends J{constructor(...e){super(...e),this.value=0,this.total=0,this.label=``,this.locale=`en`}static{this.properties={value:{type:Number},total:{type:Number},label:{type:String},locale:{type:String}}}static{this.styles=o`
    :host {
      display: grid;
  ...
  `}render(){let e=Ne(this.value,this.total),t=this.label||Z(this.locale,`progress.label`),n=Number.isFinite(this.total)&&this.total>0?this.total:0;return L`<div
      class="track"
      role="progressbar"
      aria-label=${t}
      aria-valuemin="0"
