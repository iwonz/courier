...
`,xe=class extends K{constructor(...e){super(...e),this.disabled=!1,this.type=`button`,this.variant=`secondary`}static{this.properties={disabled:{type:Boolean,reflect:!0},type:{type:String,reflect:!0},variant:{type:String,reflect:!0}}}static{this.styles=[ye,o`
  ...
  `}render(){let e=Le[Re(this.name)],t=this.label||void 0;return e.kind===`glyph`?F`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="miter" role=${t?`img`:`presentation`} aria-label=${t} aria-hidden=${t?`false`:`true`}><path d="M12 3v12m-4-4 4 4 4-4M4 17v4h16v-4"></path></svg>`:F`<span class="mask" style=${`--brand-mask: url("${e.source}")`} role=${t?`img`:`presentation`} aria-label=${t} aria-hidden=${t?`false`:`true`}></span>`}},Be=`/assets/admin.png`;function J(e){return Number(e.toFixed(2)).toString()}function Ve(e,t){if(![e.x,e.y,t.x,t.y].every(Number.isFinite))throw TypeError(`Bezier coordinates must be finite`);let n=Math.abs(t.x-e.x),r=Math.max(32,n*.42),i=t.x>=e.x?1:-1,a=e.x+r*i,o=t.x-r*i;return`M ${J(e.x)} ${J(e.y)} C ${J(a)} ${J(e.y)}, ${J(o)} ${J(t.y)}, ${J(t.x)} ${J(t.y)}`}var He=class extends K{constructor(...e){super(...e),this.product=``}static{this.properties={product:{type:String}}}static{this.styles=o`
  ...
  `}render(){return F`<i aria-hidden="true"></i><slot></slot>`}},Ge=class extends K{constructor(...e){super(...e),this.source=``,this.destination=``}static{this.properties={source:{type:String},destination:{type:String}}}static{this.styles=o`
  ...
  `}render(){let e=Ve({x:1,y:15},{x:99,y:15});return F`<div class="route"><span class="node">${this.source}</span><svg viewBox="0 0 100 30" preserveAspectRatio="none" aria-hidden="true"><path d=${e}></path><circle cx="1" cy="15" r="2.4"></circle><circle cx="99" cy="15" r="2.4"></circle></svg><span class="node">${this.destination}</span></div>`}},Ke=class extends K{constructor(...e){super(...e),this.checked=!1,this.disabled=!1,this.label=``}static{this.properties={checked:{type:Boolean,reflect:!0},disabled:{type:Boolean,reflect:!0},label:{type:String}}}static{this.styles=o`
  ...
  `}change(e){this.checked=e.currentTarget.checked,this.dispatchEvent(new CustomEvent(`courier-checkbox-change`,{detail:this.checked,bubbles:!0,composed:!0}))}render(){return F`<label>
    ...
    </label>`}},qe={en:{"theme.label":`Theme`,"theme.system":`System`,"theme.light":`Light`,"theme.dark":`Dark`,"locale.label":`Language`,"locale.en":`English`,"locale.ru":`Russian`,"progress.label":`Delivery progress`,"action.cancel":`Cancel`,"action.close":`Close`},ru:{"theme.label":`Тема`,"theme.system":`Системная`,"theme.light":`Светлая`,"theme.dark":`Тёмная`,"locale.label":`Язык`,"locale.en":`Английский`,"locale.ru":`Русский`,"progress.label":`Ход доставки`,"action.cancel":`Отмена`,"action.close":`Закрыть`}},Je=Object.keys(qe),Y=`courier.locale`;function X(e){if(!e)return;let t=e.toLowerCase().split(`-`)[0];return Je.includes(t)?t:void 0}function Ye(e){for(let t of e){let e=X(t);if(e)return e}return`en`}function Xe(e,t){if(e)try{let t=X(e.getItem(Y));if(t)return t}catch{}return Ye(t)}function Ze(e,t){if(e)try{e.setItem(Y,t)}catch{}}function Z(e,t){return qe[X(e)??`en`][t]}function Qe(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.navigator?.languages??[];return Xe(e,t)}var $e=class extends K{constructor(...e){super(...e),this.locale=`en`}static{this.properties={locale:{type:String}}}connectedCallback(){super.connectedCallback(),this.locale=Qe()}change(e){let t=X(e.detail)??`en`;this.locale=t;let n;try{n=globalThis.localStorage}catch{n=void 0}Ze(n,t),this.dispatchEvent(new CustomEvent(`courier-locale-change`,{detail:t,bubbles:!0,composed:!0}))}render(){return F`<courier-segmented-control
      icon-only
      .label=${Z(this.locale,`locale.label`)}
      .value=${this.locale}
      .options=${[{value:`en`,label:Z(this.locale,`locale.en`),symbol:`🇬🇧`},{value:`ru`,label:Z(this.locale,`locale.ru`),symbol:`🇷🇺`}]}
      data-storage-key=${Y}
      @courier-segment-change=${this.change}
    ></courier-segmented-control>`}},et=class extends K{constructor(...e){super(...e),this.heading=``}static{this.properties={heading:{type:String}}}static{this.styles=o`
    :host {
      display: block;
      overflow: hidden;
      border: 1px solid var(--courier-color-border, #c8cdbf);
  ...
  `}render(){return this.heading?F`<section aria-labelledby="courier-panel-heading">
      ...
      <slot></slot>
    </section>`:F`<section><slot></slot></section>`}};function tt(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.min(1,Math.max(0,e/t))}var nt=class extends K{constructor(...e){super(...e),this.value=0,this.total=0,this.label=``,this.locale=`en`}static{this.properties={value:{type:Number},total:{type:Number},label:{type:String},locale:{type:String}}}static{this.styles=o`
    :host {
      display: grid;
  ...
  `}render(){let e=tt(this.value,this.total),t=this.label||Z(this.locale,`progress.label`),n=Number.isFinite(this.total)&&this.total>0?this.total:0;return F`<div
      class="track"
      role="progressbar"
      aria-label=${t}
      aria-valuemin="0"
    ...
    <output>${Math.round(e*100)}%</output>`}};function rt(e,t,n){if(!(n<=0))switch(e){case`ArrowLeft`:case`ArrowUp`:return(t-1+n)%n;case`ArrowRight`:case`ArrowDown`:return(t+1)%n;case`Home`:return 0;case`End`:return n-1;default:return}}var it=class extends K{constructor(...e){super(...e),this.label=``,this.options=[],this.value=``,this.iconOnly=!1}static{this.properties={label:{type:String},options:{attribute:!1},value:{type:String},iconOnly:{type:Boolean,attribute:`icon-only`,reflect:!0}}}static{this.styles=o`
  ...
  `}activate(e){let t=e.currentTarget.dataset.value??``;t&&t!==this.value&&(this.value=t,this.dispatchEvent(new CustomEvent(`courier-segment-change`,{detail:t,bubbles:!0,composed:!0})))}move(e){let t=[...this.renderRoot.querySelectorAll(`button`)],n=t.indexOf(e.currentTarget),r=rt(e.key,n,t.length);if(r===void 0)return;e.preventDefault();let i=t[r];i.focus(),i.click()}render(){return F`<fieldset>
    ...
    </fieldset>`}};function at(e){return Math.min(100,Math.max(0,e))}function ot(e,t,n){return e.width<=0||e.height<=0?{x:50,y:50}:{x:at((t-e.left)/e.width*100),y:at((n-e.top)/e.height*100)}}var st=class extends K{constructor(...e){super(...e),this.eager=!1,this.mobileSource=``,this.source=``,this.frame=0}static{this.properties={eager:{type:Boolean},mobileSource:{type:String,attribute:`mobile-source`},source:{type:String}}}static{this.styles=o`
  ...
  `}disconnectedCallback(){this.frame&&globalThis.cancelAnimationFrame(this.frame),this.frame=0,super.disconnectedCallback()}tracksPointer(){return globalThis.matchMedia?.(`(hover: hover) and (pointer: fine)`).matches===!0&&!globalThis.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches}move(e){this.tracksPointer()&&(this.pending=ot(this.getBoundingClientRect(),e.clientX,e.clientY),!this.frame&&(this.frame=globalThis.requestAnimationFrame(()=>{this.frame=0;let e=this.pending;e&&(this.style.setProperty(`--scene-pointer-x`,`${e.x}%`),this.style.setProperty(`--scene-pointer-y`,`${e.y}%`))})))}leave(){this.pending=void 0,this.frame&&globalThis.cancelAnimationFrame(this.frame),this.frame=0,this.style.removeProperty(`--scene-pointer-x`),this.style.removeProperty(`--scene-pointer-y`)}render(){return F`<courier-mascot class="base" ?eager=${this.eager} alt="" .source=${this.source} .mobileSource=${this.mobileSource} @pointermove=${this.move} @pointerleave=${this.leave}></courier-mascot><courier-mascot class="refracted" aria-hidden="true" alt="" .source=${this.source} .mobileSource=${this.mobileSource}></courier-mascot><span class="glow" aria-hidden="true"></span><span class="veil" aria-hidden="true"></span>`}},ct=[`system`,`light`,`dark`],lt=`courier.theme`;function ut(e){return ct.includes(e)?e:`system`}function dt(e,t){return e===`system`?t?.matches?`dark`:`light`:e}function ft(e){if(!e)return`system`;try{return ut(e.getItem(lt))}catch{return`system`}}function pt(e,t){if(e)try{e.setItem(lt,t)}catch{}}var mt=class{constructor(e,t,n,r){this.root=e,this.storage=t,this.media=n,this.onSystemChange=()=>this.apply(),this.preference=r??ft(t),this.media?.addEventListener(`change`,this.onSystemChange),this.apply()}set(e){this.preference=e,pt(this.storage,e),this.apply()}destroy(){this.media?.removeEventListener(`change`,this.onSystemChange)}apply(){this.root.dataset.courierTheme=dt(this.preference,this.media),this.root.dataset.courierThemePreference=this.preference}};function ht(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.matchMedia?.(`(prefers-color-scheme: dark)`);return new mt(document.documentElement,e,t)}var gt=class extends K{constructor(...e){super(...e),this.preference=`system`,this.locale=`en`}static{this.properties={preference:{type:String},locale:{type:String}}}connectedCallback(){super.connectedCallback(),this.state=ht(),this.preference=this.state.preference}disconnectedCallback(){this.state?.destroy(),super.disconnectedCallback()}change(e){let t=ut(e.detail);this.preference=t,this.state?.set(t),this.dispatchEvent(new CustomEvent(`courier-theme-change`,{detail:t,bubbles:!0,composed:!0}))}render(){return F`<courier-segmented-control
      icon-only
  ...
  `}render(){let e=yt(this.name);return F`<svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      stroke-width="1.7"
  ...
  `]}connectedCallback(){super.connectedCallback(),this.theme=ht(),this.unsubscribe=Et(e=>{this.snapshot=e,this.failed=!1}),this.refresh()}disconnectedCallback(){this.unsubscribe?.(),this.theme?.destroy(),super.disconnectedCallback()}async refresh(){this.failed=!1,this.conflict=!1;try{this.snapshot=await Ct()}catch{this.failed=!0}}setLocale(e){this.locale=e.detail}async stop(e,t){try{await Tt(e,t),await this.refresh()}catch{this.failed=!0}}async save(e,t){e.preventDefault();let n=new FormData(e.currentTarget),r={...t.policy,version:t.policy.version+1,auth:String(n.get(`auth`)),authAttempts:Number(n.get(`attempts`)),authFailAction:String(n.get(`failAction`)),noUi:n.get(`noUi`)===`on`};this.failed=!1,this.conflict=!1;try{await wt(t,r),await this.refresh()}catch(e){this.conflict=e instanceof Error&&e.name===`ConflictError`,this.failed=!this.conflict}}t(e){return Ot(this.locale,e)}delivery(e){let t=e.source||this.t(`unavailable`),n=e.destination||this.t(`unavailable`);return F`
      <article>
    ...
    `}render(){let e=this.snapshot?.servers??[],t=e.reduce((e,t)=>e+t.deliveries.length,0),n=e.reduce((e,t)=>e+t.deliveries.reduce((e,t)=>e+t.counters.confirmed,0),0);return F`
      <main>
        ...
        <div class="workspace">
          ...
          ${this.failed?F`<div class="state-brief"><div class="state-copy"><span class="eyebrow">${this.t(`unreachable`)}</span><p role="alert">${this.t(`failed`)}</p><courier-button @click=${this.refresh}>${this.t(`retry`)}</courier-button></div><div class="state-art"><courier-mascot alt="" .source=${St}></courier-mascot></div></div>`:L}
          ...
          ${this.snapshot?e.length===0?F`<div class="state-brief"><div class="state-copy"><span class="eyebrow">${this.t(`live`)}</span><p>${this.t(`empty`)}</p></div><div class="state-art"><courier-mascot alt="" .source=${St}></courier-mascot></div></div>`:F`<div class="server-list">${e.map(e=>this.server(e))}</div>`:this.failed?L:F`<div class="loading"><courier-status>${this.t(`loading`)}</courier-status></div>`}
        </div>
      </main>
    `}};customElements.get(`courier-admin-app`)||customElements.define(`courier-admin-app`,kt);