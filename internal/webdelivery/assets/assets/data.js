...
\f\r]`,O=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,k=/-->/g,ue=/>/g,A=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),de=/'/g,fe=/"/g,pe=/^(?:script|style|textarea|title)$/i,j=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),M=Symbol.for(`lit-noChange`),N=Symbol.for(`lit-nothing`),P=new WeakMap,F=C.createTreeWalker(C,129);function I(e,t){if(!E(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return b===void 0?t:b.createHTML(t)}var me=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=O;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===O?c[1]===`!--`?o=k:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=A):(pe.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=A):o=ue:o===A?c[0]===`>`?(o=i??O,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?A:c[3]===`"`?fe:de):o===fe||o===de?o=A:o===k||o===ue?o=O:(o=A,i=void 0);let d=o===A&&e[t+1].startsWith(`/>`)?` `:``;a+=o===O?n+ce:l>=0?(r.push(s),n.slice(0,l)+x+n.slice(l)+S+d):n+S+(l===-2?t:d)}return[I(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},L=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=me(t,n);if(this.el=e.createElement(l,r),F.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=F.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(x)){let t=u[o++],n=i.getAttribute(e).split(S),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?ge:r[1]===`?`?_e:r[1]===`@`?ve:B}),i.removeAttribute(e)}else e.startsWith(S)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(pe.test(i.tagName)){let e=i.textContent.split(S),t=e.length-1;if(t>0){i.textContent=y?y.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],w()),F.nextNode(),c.push({type:2,index:++a});i.append(e[t],w())}}}else if(i.nodeType===8){if(i.data===se)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(S,e+1))!==-1;)c.push({type:7,index:a}),e+=S.length-1}}a++}}static createElement(e,t){let n=C.createElement(`template`);return n.innerHTML=e,n}};function R(e,t,n=e,r){if(t===M)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=T(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=R(e,i._$AS(e,t.values),i,r)),t}var he=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??C).importNode(t,!0);F.currentNode=r;let i=F.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new z(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new ye(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=F.nextNode(),a++)}return F.currentNode=C,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},z=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=R(this,e,t),T(e)?e===N||e==null||e===``?(this._$AH!==N&&this._$AR(),this._$AH=N):e!==this._$AH&&e!==M&&this._(e):e._$litType$===void 0?e.nodeType===void 0?le(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==N&&T(this._$AH)?this._$AA.nextSibling.data=e:this.T(C.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=L.createElement(I(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new he(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=P.get(e.strings);return t===void 0&&P.set(e.strings,t=new L(e)),t}k(t){E(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(w()),this.O(w()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=v(e).nextSibling;v(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},B=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=N,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=N}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=R(this,e,t,0),a=!T(e)||e!==this._$AH&&e!==M,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=R(this,r[n+o],t,o),s===M&&(s=this._$AH[o]),a||=!T(s)||s!==this._$AH[o],s===N?e=N:e!==N&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},ge=class extends B{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===N?void 0:e}},_e=class extends B{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==N)}},ve=class extends B{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=R(this,e,t,0)??N)===M)return;let n=this._$AH,r=e===N&&n!==N||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==N&&(n===N||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ye=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){R(this,e)}},be=_.litHtmlPolyfillSupport;be?.(L,z),(_.litHtmlVersions??=[]).push(`3.3.3`);var xe=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new z(t.insertBefore(w(),e),e,void 0,n??{})}return i._$AI(e),i},V=globalThis,H=class extends g{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};H._$litElement$=!0,H.finalized=!0,V.litElementHydrateSupport?.({LitElement:H});var Se=V.litElementPolyfillSupport;Se?.({LitElement:H}),(V.litElementVersions??=[]).push(`4.2.2`);var Ce=o`
  :host {
...
`,Te=class extends H{constructor(...e){super(...e),this.disabled=!1,this.type=`button`,this.variant=`secondary`}static{this.properties={disabled:{type:Boolean,reflect:!0},type:{type:String,reflect:!0},variant:{type:String,reflect:!0}}}static{this.styles=[Ce,o`
  ...
  `}render(){let e=He[Ue(this.name)],t=this.label||void 0;return e.kind===`glyph`?j`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="miter" role=${t?`img`:`presentation`} aria-label=${t} aria-hidden=${t?`false`:`true`}><path d="M12 3v12m-4-4 4 4 4-4M4 17v4h16v-4"></path></svg>`:j`<span class="mask" style=${`--brand-mask: url("${e.source}")`} role=${t?`img`:`presentation`} aria-label=${t} aria-hidden=${t?`false`:`true`}></span>`}},Ge=`/assets/data-courier-swift-mark-v1.webp`;function U(e){return Number(e.toFixed(2)).toString()}function Ke(e,t){if(![e.x,e.y,t.x,t.y].every(Number.isFinite))throw TypeError(`Bezier coordinates must be finite`);let n=Math.abs(t.x-e.x),r=Math.max(32,n*.42),i=t.x>=e.x?1:-1,a=e.x+r*i,o=t.x-r*i;return`M ${U(e.x)} ${U(e.y)} C ${U(a)} ${U(e.y)}, ${U(o)} ${U(t.y)}, ${U(t.x)} ${U(t.y)}`}var qe=class extends H{static{this.styles=o`
  ...
  `}render(){return j`<span class="lockup"><img part="mark" src=${Ge} alt="" decoding="async"><strong part="wordmark">Courier</strong></span>`}},Je=class extends H{constructor(...e){super(...e),this.alt=``,this.eager=!1,this.mobileSource=``,this.source=``}static{this.properties={alt:{type:String},eager:{type:Boolean},mobileSource:{type:String,attribute:`mobile-source`},source:{type:String}}}static{this.styles=o`:host { display: block; } picture { display: contents; } img { display: block; width: 100%; height: auto; }`}render(){return j`<picture>${this.mobileSource?j`<source media="(max-width: 44rem)" srcset=${this.mobileSource}>`:``}<img part="image" src=${this.source} alt=${this.alt} decoding="async" loading=${this.eager?`eager`:`lazy`} fetchpriority=${this.eager?`high`:`auto`}></picture>`}},Ye=class extends H{constructor(...e){super(...e),this.tone=`neutral`}static{this.properties={tone:{type:String,reflect:!0}}}static{this.styles=o`
  ...
  `}render(){return j`<i aria-hidden="true"></i><slot></slot>`}},Xe=class extends H{constructor(...e){super(...e),this.source=``,this.destination=``}static{this.properties={source:{type:String},destination:{type:String}}}static{this.styles=o`
  ...
  `}change(e){this.checked=e.currentTarget.checked,this.dispatchEvent(new CustomEvent(`courier-checkbox-change`,{detail:this.checked,bubbles:!0,composed:!0}))}render(){return j`<label>
      <input type="checkbox" .checked=${this.checked} .disabled=${this.disabled} @change=${this.change}>
      <span class="box" aria-hidden="true"></span>
      <span>${this.label}</span>
    </label>`}},Qe=class extends H{constructor(...e){super(...e),this.href=``,this.icon=`github`,this.label=``,this.target=`_blank`,this.rel=`noopener noreferrer`}static{this.properties={href:{type:String},icon:{type:String},label:{type:String},target:{type:String},rel:{type:String}}}static{this.styles=o`
    :host { display: inline-flex; }
    a {
  ...
  `}render(){return j`<a href=${this.href} target=${this.target} rel=${this.rel} aria-label=${this.label} title=${this.label}><courier-icon name=${this.icon}></courier-icon></a>`}},$e={en:{"theme.label":`Theme`,"theme.system":`System`,"theme.light":`Light`,"theme.dark":`Dark`,"locale.label":`Language`,"locale.en":`English`,"locale.ru":`Russian`,"preference.next":`Next`,"progress.label":`Delivery progress`,"action.cancel":`Cancel`,"action.close":`Close`},ru:{"theme.label":`Тема`,"theme.system":`Системная`,"theme.light":`Светлая`,"theme.dark":`Тёмная`,"locale.label":`Язык`,"locale.en":`Английский`,"locale.ru":`Русский`,"preference.next":`Следующая`,"progress.label":`Ход доставки`,"action.cancel":`Отмена`,"action.close":`Закрыть`}},et=Object.keys($e),tt=`courier.locale`;function W(e){if(!e)return;let t=e.toLowerCase().split(`-`)[0];return et.includes(t)?t:void 0}function nt(e){for(let t of e){let e=W(t);if(e)return e}return`en`}function rt(e,t){if(e)try{let t=W(e.getItem(tt));if(t)return t}catch{}return nt(t)}function it(e,t){if(e)try{e.setItem(tt,t)}catch{}}function G(e,t){return $e[W(e)??`en`][t]}function at(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.navigator?.languages??[];return rt(e,t)}var ot=[`system`,`light`,`dark`],st=`courier.theme`;function ct(e){return ot.includes(e)?e:`system`}function lt(e,t){return e===`system`?t?.matches?`dark`:`light`:e}function ut(e){if(!e)return`system`;try{return ct(e.getItem(st))}catch{return`system`}}function dt(e,t){if(e)try{e.setItem(st,t)}catch{}}var ft=class{constructor(e,t,n,r){this.root=e,this.storage=t,this.media=n,this.onSystemChange=()=>this.apply(),this.preference=r??ut(t),this.media?.addEventListener(`change`,this.onSystemChange),this.apply()}set(e){this.preference=e,dt(this.storage,e),this.apply()}destroy(){this.media?.removeEventListener(`change`,this.onSystemChange)}apply(){this.root.dataset.courierTheme=lt(this.preference,this.media),this.root.dataset.courierThemePreference=this.preference}},K=[`system`,`light`,`dark`],q=[`en`,`ru`];function J(e,t){return e[(e.indexOf(t)+1)%e.length]}var pt=class extends EventTarget{constructor(e,t,n,r,i){super(),this.storage=t,this.themeState=new ft(e,t,n,i),this.locale=rt(t,r)}get theme(){return this.themeState.preference}setTheme(e){return this.themeState.set(e),this.dispatchEvent(new Event(`change`)),e}cycleTheme(){return this.setTheme(J(K,this.theme))}setLocale(e){return this.locale=e,it(this.storage,e),this.dispatchEvent(new Event(`change`)),e}cycleLocale(){return this.setLocale(J(q,this.locale))}destroy(){this.themeState.destroy()}},Y;function mt(){if(Y)return Y;let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.matchMedia?.(`(prefers-color-scheme: dark)`),n=globalThis.navigator?.languages??[];return Y=new pt(document.documentElement,e,t,n),Y}var ht={en:`🇬🇧`,ru:`🇷🇺`},gt=class extends H{constructor(...e){super(...e),this.locale=`en`,this.synchronize=()=>{this.controller&&(this.locale=this.controller.locale)}}static{this.properties={locale:{type:String}}}static{this.styles=o`
    :host { display: inline-flex; }
  ...
  `}connectedCallback(){super.connectedCallback(),this.controller=mt(),this.synchronize(),this.controller.addEventListener(`change`,this.synchronize)}disconnectedCallback(){this.controller?.removeEventListener(`change`,this.synchronize),super.disconnectedCallback()}cycle(){let e=this.controller?.cycleLocale()??J(q,this.locale);this.locale=e,this.dispatchEvent(new CustomEvent(`courier-locale-change`,{detail:e,bubbles:!0,composed:!0}))}render(){let e=J(q,this.locale),t=`${G(this.locale,`locale.label`)}: ${G(this.locale,`locale.${this.locale}`)}. ${G(this.locale,`preference.next`)}: ${G(this.locale,`locale.${e}`)}`;return j`<button type="button" aria-label=${t} title=${t} @click=${this.cycle}><span aria-hidden="true">${ht[this.locale]}</span></button>`}},_t=class extends H{constructor(...e){super(...e),this.heading=``}static{this.properties={heading:{type:String}}}static{this.styles=o`
    :host {
      display: block;
      overflow: hidden;
      border: 1px solid var(--courier-color-border, #c8cdbf);
  ...
  `}render(){return this.heading?j`<section aria-labelledby="courier-panel-heading">
      <h2 id="courier-panel-heading">${this.heading}</h2>
      <slot></slot>
    </section>`:j`<section><slot></slot></section>`}};function vt(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.min(1,Math.max(0,e/t))}var yt=class extends H{constructor(...e){super(...e),this.value=0,this.total=0,this.label=``,this.locale=`en`}static{this.properties={value:{type:Number},total:{type:Number},label:{type:String},locale:{type:String}}}static{this.styles=o`
    :host {
      display: grid;
  ...
  `}render(){let e=vt(this.value,this.total),t=this.label||G(this.locale,`progress.label`),n=Number.isFinite(this.total)&&this.total>0?this.total:0;return j`<div
      class="track"
      role="progressbar"
      aria-label=${t}
      aria-valuemin="0"
    ...
    <output>${Math.round(e*100)}%</output>`}},bt=class extends H{constructor(...e){super(...e),this.eager=!1,this.mobileSource=``,this.source=``,this.active=!1}static{this.properties={eager:{type:Boolean},mobileSource:{type:String,attribute:`mobile-source`},source:{type:String},active:{state:!0}}}static{this.styles=o`
  ...
  `}connectedCallback(){super.connectedCallback(),this.configureLoading()}disconnectedCallback(){this.proximityObserver?.disconnect(),this.proximityObserver=void 0,super.disconnectedCallback()}updated(e){e.has(`eager`)&&this.eager&&this.activate()}configureLoading(){if(!this.active){if(this.eager){this.activate();return}if(!globalThis.IntersectionObserver){this.active=!0;return}this.proximityObserver=new IntersectionObserver(e=>{e.some(e=>e.isIntersecting)&&this.activate()},{rootMargin:`100% 0px`,threshold:0}),this.proximityObserver.observe(this)}}activate(){this.active=!0,this.proximityObserver?.disconnect(),this.proximityObserver=void 0}render(){return j`${this.active?j`<courier-mascot class="base" ?eager=${this.eager} alt="" .source=${this.source} .mobileSource=${this.mobileSource}></courier-mascot>`:``}<span class="veil" aria-hidden="true"></span>`}},xt={system:`system`,light:`sun`,dark:`moon`},St=class extends H{constructor(...e){super(...e),this.preference=`system`,this.locale=`en`,this.synchronize=()=>{this.controller&&(this.preference=this.controller.theme)}}static{this.properties={preference:{type:String},locale:{type:String}}}static{this.styles=o`
    :host { display: inline-flex; }
    ...
    button:focus-visible { outline: var(--courier-control-frame-focus-width, 3px) solid var(--courier-control-frame-focus, #d95f2b); outline-offset: 2px; }
    courier-icon { width: 1.05rem; height: 1.05rem; }
  `}connectedCallback(){super.connectedCallback(),this.controller=mt(),this.synchronize(),this.controller.addEventListener(`change`,this.synchronize)}disconnectedCallback(){this.controller?.removeEventListener(`change`,this.synchronize),super.disconnectedCallback()}cycle(){let e=this.controller?.cycleTheme()??J(K,this.preference);this.preference=e,this.dispatchEvent(new CustomEvent(`courier-theme-change`,{detail:e,bubbles:!0,composed:!0}))}render(){let e=J(K,this.preference),t=G(this.locale,`theme.${this.preference}`),n=G(this.locale,`theme.${e}`),r=`${G(this.locale,`theme.label`)}: ${t}. ${G(this.locale,`preference.next`)}: ${n}`;return j`<button type="button" aria-label=${r} title=${r} @click=${this.cycle}><courier-icon name=${xt[this.preference]}></courier-icon></button>`}},Ct=class extends H{constructor(...e){super(...e),this.heading=``,this.status=``}static{this.properties={heading:{type:String},status:{type:String}}}static{this.styles=o`
  ...
  `}render(){let e=Dt(this.name);return j`<svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      stroke-width="1.7"
    ...
    ><path d=${Et[e]}></path></svg>`}},"courier-icon-link":Qe,"courier-locale-selector":gt,"courier-mascot":Je,"courier-panel":_t,"courier-progress":yt,"courier-route":Xe,"courier-scene":bt,"courier-status":Ye,"courier-theme-selector":St,"courier-workbench":Ct,"courier-command-readout":wt};function kt(e=customElements){for(let[t,n]of Object.entries(Ot))e.get(t)||e.define(t,n)}var At=`/assets/data-landing-hero-mobile-v1.webp`,jt=`/assets/data-landing-hero-wide-v1.webp`,Mt=At;function X(e,t=``,n=globalThis.location.pathname){let r=n.endsWith(`/`)?n:`${n}/`,i=new URL(`api/v1/${e}`,globalThis.location.origin);return i.pathname=`${r}api/v1/${e}`,t&&i.searchParams.set(`path`,t),`${i.pathname}${i.search}`}async function Z(e){if(!e.ok)throw Error(`Courier request failed (${e.status})`);return e.json()}async function Nt(e=``,t=globalThis.fetch){return Z(await t(X(`meta`,e),{credentials:`same-origin`}))}async function Pt(e,t=globalThis.fetch){return Z(await t(X(`session`),{method:`POST`,credentials:`same-origin`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:e})}))}async function Ft(e,t,n=globalThis.fetch){let r=new FormData;r.append(`file`,e),await Z(await n(X(`upload`),{method:`POST`,credentials:`same-origin`,headers:{"X-Courier-CSRF":t,"X-Courier-File-Size":String(e.size)},body:r}))}function Q(e,t=!1){let n=new URL(X(`download`,e),globalThis.location.origin);return t&&n.searchParams.set(`archive`,`tar.gz`),`${n.pathname}${n.search}`}function It(e,t){return e?`${e}/${t}`:t}function Lt(e){let t=e.lastIndexOf(`/`);return t<0?``:e.slice(0,t)}var Rt={en:{title:`Courier delivery`,privateRoute:`Private route`,loading:`Preparing the delivery route…`,retry:`Retry connection`,download:`Download file`,downloadArchive:`Download as archive`,downloadAll:`Download directory`,upload:`Choose a file`,uploadTitle:`Dispatch a file`,uploadHelp:`Select one file. Courier checks policy and reserves the final path before committing it.`,up:`Parent directory`,password:`Delivery password`,signIn:`Verify access`,accessTitle:`Identity check`,accessHelp:`This route is protected. Verify access to reveal its delivery metadata.`,empty:`No entries are available at this path.`,failed:`The route is unavailable or authorization is required. No delivery metadata was revealed.`,ready:`Route ready`,manifest:`Delivery manifest`,confirmed:`Verified handoff`,entryTypeFile:`File`,entryTypeDirectory:`Directory`,itemSize:`Bytes`},ru:{title:`Доставка Courier`,privateRoute:`Приватный маршрут`,loading:`Подготовка маршрута доставки…`,retry:`Повторить подключение`,download:`Скачать файл`,downloadArchive:`Скачать архивом`,downloadAll:`Скачать каталог`,upload:`Выбрать файл`,uploadTitle:`Отправить файл`,uploadHelp:`Выберите один файл. Courier проверит правила и зарезервирует конечный путь до фиксации.`,up:`Родительский каталог`,password:`Пароль доставки`,signIn:`Подтвердить доступ`,accessTitle:`Проверка доступа`,accessHelp:`Маршрут защищён. Подтвердите доступ, чтобы увидеть данные доставки.`,empty:`По этому пути нет доступных объектов.`,failed:`Маршрут недоступен или требуется авторизация. Данные доставки не были раскрыты.`,ready:`Маршрут готов`,manifest:`Манифест доставки`,confirmed:`Подтверждённая передача`,entryTypeFile:`Файл`,entryTypeDirectory:`Каталог`,itemSize:`Байт`}};function zt(e,t){return Rt[e][t]}kt();var Bt=class extends H{constructor(...e){super(...e),this.locale=at(),this.failed=!1,this.csrf=``}static{this.properties={locale:{state:!0},metadata:{state:!0},failed:{state:!0},csrf:{state:!0}}}static{this.styles=[we,o`
    :host {
      display: block;
      min-height: 100vh;
      padding: 0 1rem 3rem;
  ...
  `]}connectedCallback(){super.connectedCallback(),this.refresh()}disconnectedCallback(){super.disconnectedCallback()}async refresh(e=this.metadata?.path??``){this.failed=!1;try{this.metadata=await Nt(e)}catch{this.failed=!0,this.metadata=void 0}}async openDirectory(e,t){e.preventDefault(),await this.refresh(t)}async signIn(e){e.preventDefault();let t=e.currentTarget,n=new FormData(t).get(`password`)?.toString()??``;try{this.csrf=(await Pt(n)).csrf,t.reset(),await this.refresh()}catch{this.failed=!0}}async sendFile(e){let t=e.currentTarget,n=t.files?.item(0);if(n)try{await Ft(n,this.csrf),t.value=``,await this.refresh()}catch{this.failed=!0}}setLocale(e){this.locale=e.detail}t(e){return zt(this.locale,e)}entry(e){let t=It(this.metadata.path,e.name);return e.type===`directory`?j`<li><courier-icon name="folder"></courier-icon><button class="link entry-name" @click=${e=>this.openDirectory(e,t)}>${e.name}</button><span class="size">${e.size} ${this.t(`itemSize`)}</span><a href=${Q(t,!0)}>${this.t(`downloadArchive`)}</a></li>`:j`<li><courier-icon name="parcel"></courier-icon><span class="entry-name">${e.name}</span><span class="size">${e.size} ${this.t(`itemSize`)}</span><a href=${Q(t)}>${this.t(`download`)}</a></li>`}render(){let e=this.metadata?.entries??[];return j`
      <courier-scene class="page-scene" eager .source=${jt} .mobileSource=${Mt}></courier-scene>
      <main>
        <header>
        ...
        <div class="workspace">
          <div class="operation-head"><div><span class="eyebrow">${this.t(`privateRoute`)}</span><h1>${this.t(`title`)}</h1></div>${this.metadata?j`<courier-status tone="signal">${this.t(`ready`)}</courier-status>`:N}</div>
          ${this.failed?j`
          ...
          ${this.metadata?j`
            ...
            <courier-workbench class="delivery-panel" .heading=${this.t(`manifest`)} .status=${this.t(`ready`)}>
              ...
              `:j`
                ${this.metadata.type===`file`?j`<div class="toolbar"><courier-icon name="download"></courier-icon><a href=${Q(this.metadata.path)}>${this.t(`download`)}</a></div>`:j`
                  <div class="toolbar"><a href=${Q(this.metadata.path,!0)}>${this.t(`downloadAll`)}</a>${this.metadata.path?j`<button class="link" @click=${e=>this.openDirectory(e,Lt(this.metadata.path))}>${this.t(`up`)}</button>`:N}</div>
                  ${e.length===0?j`<p class="muted">${this.t(`empty`)}</p>`:j`<ul>${e.map(e=>this.entry(e))}</ul>`}
                `}
              `}
            </courier-workbench>
          `:this.failed?N:j`<courier-workbench class="loading" .heading=${this.t(`privateRoute`)} status="running"><courier-status>${this.t(`loading`)}</courier-status></courier-workbench>`}
        </div>
      </main>
    `}},$=document.createElement(`link`);$.rel=`icon`,$.type=`image/webp`,$.href=Ge,document.head.append($),customElements.get(`courier-data-app`)||customElements.define(`courier-data-app`,Bt);