...
`,we=class extends U{constructor(...e){super(...e),this.disabled=!1,this.type=`button`,this.variant=`secondary`}static{this.properties={disabled:{type:Boolean,reflect:!0},type:{type:String,reflect:!0},variant:{type:String,reflect:!0}}}static{this.styles=[Se,o`
  ...
  `}change(e){this.checked=e.currentTarget.checked,this.dispatchEvent(new CustomEvent(`courier-checkbox-change`,{detail:this.checked,bubbles:!0,composed:!0}))}render(){return P`<label>
    ...
    </label>`}},Xe=class extends U{constructor(...e){super(...e),this.href=``,this.icon=`github`,this.label=``,this.target=`_blank`,this.rel=`noopener noreferrer`}static{this.properties={href:{type:String},icon:{type:String},label:{type:String},target:{type:String},rel:{type:String}}}static{this.styles=o`
    :host { display: inline-flex; }
    a {
  ...
  `}render(){return P`<a href=${this.href} target=${this.target} rel=${this.rel} aria-label=${this.label} title=${this.label}><courier-icon name=${this.icon}></courier-icon></a>`}},K={en:{"theme.label":`Theme`,"theme.system":`System`,"theme.light":`Light`,"theme.dark":`Dark`,"locale.label":`Language`,"locale.en":`English`,"locale.ru":`Russian`,"progress.label":`Delivery progress`,"action.cancel":`Cancel`,"action.close":`Close`},ru:{"theme.label":`Тема`,"theme.system":`Системная`,"theme.light":`Светлая`,"theme.dark":`Тёмная`,"locale.label":`Язык`,"locale.en":`Английский`,"locale.ru":`Русский`,"progress.label":`Ход доставки`,"action.cancel":`Отмена`,"action.close":`Закрыть`}},Ze=Object.keys(K),q=`courier.locale`;function J(e){if(!e)return;let t=e.toLowerCase().split(`-`)[0];return Ze.includes(t)?t:void 0}function Qe(e){for(let t of e){let e=J(t);if(e)return e}return`en`}function $e(e,t){if(e)try{let t=J(e.getItem(q));if(t)return t}catch{}return Qe(t)}function et(e,t){if(e)try{e.setItem(q,t)}catch{}}function Y(e,t){return K[J(e)??`en`][t]}function tt(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.navigator?.languages??[];return $e(e,t)}var nt=class extends U{constructor(...e){super(...e),this.locale=`en`}static{this.properties={locale:{type:String}}}connectedCallback(){super.connectedCallback(),this.locale=tt()}change(e){let t=J(e.detail)??`en`;this.locale=t;let n;try{n=globalThis.localStorage}catch{n=void 0}et(n,t),this.dispatchEvent(new CustomEvent(`courier-locale-change`,{detail:t,bubbles:!0,composed:!0}))}render(){return P`<courier-segmented-control
      icon-only
    ...
    ></courier-segmented-control>`}},rt=class extends U{constructor(...e){super(...e),this.heading=``}static{this.properties={heading:{type:String}}}static{this.styles=o`
    :host {
      display: block;
      overflow: hidden;
      border: 1px solid var(--courier-color-border, #c8cdbf);
  ...
  `}render(){return this.heading?P`<section aria-labelledby="courier-panel-heading">
      ...
      <slot></slot>
    </section>`:P`<section><slot></slot></section>`}};function it(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.min(1,Math.max(0,e/t))}var at=class extends U{constructor(...e){super(...e),this.value=0,this.total=0,this.label=``,this.locale=`en`}static{this.properties={value:{type:Number},total:{type:Number},label:{type:String},locale:{type:String}}}static{this.styles=o`
    :host {
      display: grid;
  ...
  `}render(){let e=it(this.value,this.total),t=this.label||Y(this.locale,`progress.label`),n=Number.isFinite(this.total)&&this.total>0?this.total:0;return P`<div
      class="track"
      role="progressbar"
      aria-label=${t}
      aria-valuemin="0"
    ...
    <output>${Math.round(e*100)}%</output>`}};function ot(e,t,n){if(!(n<=0))switch(e){case`ArrowLeft`:case`ArrowUp`:return(t-1+n)%n;case`ArrowRight`:case`ArrowDown`:return(t+1)%n;case`Home`:return 0;case`End`:return n-1;default:return}}var st=class extends U{constructor(...e){super(...e),this.label=``,this.options=[],this.value=``,this.iconOnly=!1}static{this.properties={label:{type:String},options:{attribute:!1},value:{type:String},iconOnly:{type:Boolean,attribute:`icon-only`,reflect:!0}}}static{this.styles=o`
  ...
  `}activate(e){let t=e.currentTarget.dataset.value??``;t&&t!==this.value&&(this.value=t,this.dispatchEvent(new CustomEvent(`courier-segment-change`,{detail:t,bubbles:!0,composed:!0})))}move(e){let t=[...this.renderRoot.querySelectorAll(`button`)],n=t.indexOf(e.currentTarget),r=ot(e.key,n,t.length);if(r===void 0)return;e.preventDefault();let i=t[r];i.focus(),i.click()}render(){return P`<fieldset>
    ...
    </fieldset>`}},ct={x:72,y:42};function lt(e){return Math.min(100,Math.max(0,e))}function ut(e,t,n){return e.width<=0||e.height<=0?{x:50,y:50}:{x:lt((t-e.left)/e.width*100),y:lt((n-e.top)/e.height*100)}}function dt(e,t,n){let r=1-Math.exp(-Math.min(48,Math.max(0,n))/42),i={x:e.x+(t.x-e.x)*r,y:e.y+(t.y-e.y)*r},a=Math.hypot(t.x-i.x,t.y-i.y)<.04;return{position:a?t:i,settled:a}}var ft=class extends U{constructor(...e){super(...e),this.eager=!1,this.mobileSource=``,this.source=``,this.active=!1,this.refracting=!1,this.frame=0,this.current=ct,this.returning=!1,this.handlePointerMove=e=>this.move(e),this.handlePointerLeave=()=>this.leave()}static{this.properties={eager:{type:Boolean},mobileSource:{type:String,attribute:`mobile-source`},source:{type:String},active:{state:!0},refracting:{state:!0}}}static{this.styles=o`
  ...
  `}connectedCallback(){super.connectedCallback(),this.addEventListener(`pointermove`,this.handlePointerMove),this.addEventListener(`pointerleave`,this.handlePointerLeave),this.configureLoading()}disconnectedCallback(){this.removeEventListener(`pointermove`,this.handlePointerMove),this.removeEventListener(`pointerleave`,this.handlePointerLeave),this.proximityObserver?.disconnect(),this.proximityObserver=void 0,this.frame&&globalThis.cancelAnimationFrame(this.frame),this.frame=0,this.target=void 0,this.previousTimestamp=void 0,this.refracting=!1,super.disconnectedCallback()}updated(e){e.has(`eager`)&&this.eager&&this.activate()}configureLoading(){if(!this.active){if(this.eager){this.activate();return}if(!globalThis.IntersectionObserver){this.active=!0;return}this.proximityObserver=new IntersectionObserver(e=>{e.some(e=>e.isIntersecting)&&this.activate()},{rootMargin:`50% 0px`,threshold:0}),this.proximityObserver.observe(this)}}activate(){this.active=!0,this.proximityObserver?.disconnect(),this.proximityObserver=void 0}tracksPointer(){return globalThis.matchMedia?.(`(hover: hover) and (pointer: fine)`).matches===!0&&!globalThis.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches}move(e){this.active&&this.tracksPointer()&&(this.refracting=!0,this.target=ut(this.getBoundingClientRect(),e.clientX,e.clientY),this.returning=!1,this.schedule())}leave(){this.tracksPointer()&&(this.target=ct,this.returning=!0,this.schedule())}schedule(){this.frame||=globalThis.requestAnimationFrame(e=>this.advance(e))}advance(e){this.frame=0;let t=this.target;if(!t)return;let n=this.previousTimestamp===void 0?16:e-this.previousTimestamp;this.previousTimestamp=e;let r=dt(this.current,t,n);if(this.current=r.position,this.style.setProperty(`--scene-pointer-x`,`${this.current.x}%`),this.style.setProperty(`--scene-pointer-y`,`${this.current.y}%`),!r.settled){this.schedule();return}this.previousTimestamp=void 0,this.returning&&(this.target=void 0,this.returning=!1,this.refracting=!1,this.style.removeProperty(`--scene-pointer-x`),this.style.removeProperty(`--scene-pointer-y`))}render(){return P`<div class="tracking">${this.active?P`<courier-mascot class="base" ?eager=${this.eager} alt="" .source=${this.source} .mobileSource=${this.mobileSource}></courier-mascot>${this.refracting?P`<courier-mascot class="refracted" aria-hidden="true" alt="" .source=${this.source} .mobileSource=${this.mobileSource}></courier-mascot>`:I}`:I}<span class="glow" aria-hidden="true"></span><span class="veil" aria-hidden="true"></span></div>`}},pt=[`system`,`light`,`dark`],mt=`courier.theme`;function ht(e){return pt.includes(e)?e:`system`}function gt(e,t){return e===`system`?t?.matches?`dark`:`light`:e}function _t(e){if(!e)return`system`;try{return ht(e.getItem(mt))}catch{return`system`}}function vt(e,t){if(e)try{e.setItem(mt,t)}catch{}}var yt=class{constructor(e,t,n,r){this.root=e,this.storage=t,this.media=n,this.onSystemChange=()=>this.apply(),this.preference=r??_t(t),this.media?.addEventListener(`change`,this.onSystemChange),this.apply()}set(e){this.preference=e,vt(this.storage,e),this.apply()}destroy(){this.media?.removeEventListener(`change`,this.onSystemChange)}apply(){this.root.dataset.courierTheme=gt(this.preference,this.media),this.root.dataset.courierThemePreference=this.preference}};function X(){let e;try{e=globalThis.localStorage}catch{e=void 0}let t=globalThis.matchMedia?.(`(prefers-color-scheme: dark)`);return new yt(document.documentElement,e,t)}var bt=class extends U{constructor(...e){super(...e),this.preference=`system`,this.locale=`en`}static{this.properties={preference:{type:String},locale:{type:String}}}connectedCallback(){super.connectedCallback(),this.state=X(),this.preference=this.state.preference}disconnectedCallback(){this.state?.destroy(),super.disconnectedCallback()}change(e){let t=ht(e.detail);this.preference=t,this.state?.set(t),this.dispatchEvent(new CustomEvent(`courier-theme-change`,{detail:t,bubbles:!0,composed:!0}))}render(){return P`<courier-segmented-control
      icon-only
      ...
      @courier-segment-change=${this.change}
    ></courier-segmented-control>`}},xt=class extends U{constructor(...e){super(...e),this.heading=``,this.status=``}static{this.properties={heading:{type:String},status:{type:String}}}static{this.styles=o`
    :host {
      display: grid;
      min-width: 0;
      min-height: 0;
  ...
  `]}connectedCallback(){super.connectedCallback(),this.theme=X(),this.refresh()}disconnectedCallback(){this.theme?.destroy(),super.disconnectedCallback()}async refresh(e=this.metadata?.path??``){this.failed=!1;try{this.metadata=await jt(e)}catch{this.failed=!0,this.metadata=void 0}}async openDirectory(e,t){e.preventDefault(),await this.refresh(t)}async signIn(e){e.preventDefault();let t=e.currentTarget,n=new FormData(t).get(`password`)?.toString()??``;try{this.csrf=(await Mt(n)).csrf,t.reset(),await this.refresh()}catch{this.failed=!0}}async sendFile(e){let t=e.currentTarget,n=t.files?.item(0);if(n)try{await Nt(n,this.csrf),t.value=``,await this.refresh()}catch{this.failed=!0}}setLocale(e){this.locale=e.detail}t(e){return Lt(this.locale,e)}entry(e){let t=Pt(this.metadata.path,e.name);return e.type===`directory`?P`<li><courier-icon name="folder"></courier-icon><button class="link entry-name" @click=${e=>this.openDirectory(e,t)}>${e.name}</button><span class="size">${e.size} ${this.t(`itemSize`)}</span><a href=${$(t,!0)}>${this.t(`downloadArchive`)}</a></li>`:P`<li><courier-icon name="parcel"></courier-icon><span class="entry-name">${e.name}</span><span class="size">${e.size} ${this.t(`itemSize`)}</span><a href=${$(t)}>${this.t(`download`)}</a></li>`}render(){let e=this.metadata?.entries??[];return P`
      <courier-scene class="page-scene" eager .source=${kt} .mobileSource=${At}></courier-scene>
      <main>
        <header>
