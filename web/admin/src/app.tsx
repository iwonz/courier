  ...
  return <div className="min-h-screen px-4 pb-16 sm:px-6 lg:px-8">
    ...
    <main className="mx-auto grid w-full max-w-7xl gap-6 pt-8 sm:pt-12">
      ...
      <div data-courier-metrics className="grid divide-y divide-border/35 sm:grid-cols-3 sm:divide-x sm:divide-y-0">
        <div className="flex items-center gap-4 py-5 sm:px-5 sm:first:pl-0"><span className="text-primary"><ServerCog /></span><div><strong className="font-mono text-2xl">{servers.length}</strong><p className="text-xs text-muted-foreground">{t("serversMetric")}</p></div></div>
        <div className="flex items-center gap-4 py-5 sm:px-5"><span className="text-primary"><Workflow /></span><div><strong className="font-mono text-2xl">{deliveries.length}</strong><p className="text-xs text-muted-foreground">{t("deliveriesMetric")}</p></div></div>
        <div className="flex items-center gap-4 py-5 sm:px-5 sm:last:pr-0"><span className="text-primary"><Database /></span><div><strong className="font-mono text-2xl">{confirmed}</strong><p className="text-xs text-muted-foreground">{t("confirmedMetric")}</p></div></div>
      </div>
