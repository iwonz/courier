...
export class CourierLandingApp extends LitElement {
  ...
  static styles = css`
    ...
    .hero-visual courier-mascot { position: absolute; z-index: 1; right: -7%; bottom: -9%; width: min(104%, 31rem); }
    ...
    .install-primary { display: grid; grid-template-columns: 0.8fr 1.2fr; gap: 1rem; align-items: stretch; }
    .install-copy { display: grid; align-content: center; gap: 0.75rem; padding: clamp(1.5rem, 4vw, 3rem); border-radius: var(--courier-radius-md); color: var(--courier-paper-50); background: var(--courier-graphite-900); }
    ...
    .install-primary courier-mascot { align-self: end; justify-self: center; width: min(100%, 19rem); }
    ...
    @media (max-width: 58rem) {
      ...
      .install-primary courier-mascot { display: none; }
    }
        ...
        <div class="shell">
          ...
          <div class="hero">
            ...
            <div class="hero-visual" aria-label=${this.t("heroRouteLabel")}>
              ...
              <courier-mascot alt="" .source=${relayMascotSource}></courier-mascot>
