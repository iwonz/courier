...
export const iconNames = [
  "apple", "archive", "browser-share", "browser-upload", "check", "copy", "download", "folder", "folder-in", "folder-out", "github", "homebrew", "linux", "moon", "npm", "package", "parcel", "pnpm", "receipt", "retry", "route", "scoop", "server", "server-in", "server-out", "shield", "sun", "system", "terminal", "upload", "webhook-in", "webhook-out", "windows", "yarn",
] as const;
...
const paths: Record<IconName, string> = {
  ...
  "browser-share": "M3 4h18v15H3zM3 8h18M7 6h.01M10 6h.01M14 15c2-3 4-4 7-4m-3-2 3 2-1 4",
  "browser-upload": "M3 4h18v15H3zM3 8h18M7 6h.01M10 6h.01M12 17v-6m-3 3 3-3 3 3",
  check: "m4 12 5 5L20 6",
  copy: "M8 3h13v13M3 8h13v13H3z",
  download: "M12 3v13m-5-5 5 5 5-5M4 15v6h16v-6",
  folder: "M3 6h7l2 3h9v12H3zM3 6V3h7l2 3h9v3",
  "folder-in": "M3 6h7l2 3h9v12H3zM3 6V3h7l2 3h9v3m12 6h-7m3-3-3 3 3 3",
  "folder-out": "M3 6h7l2 3h9v12H3zM3 6V3h7l2 3h9v3m5 6h7m-3-3 3 3-3 3",
  ...
  "server-in": "M3 2h18v8H3zM3 14h18v8H3zM7 6h1m3 0h6M7 18h1m7-12h-6m3-3-3 3 3 3",
  "server-out": "M3 2h18v8H3zM3 14h18v8H3zM7 6h1m3 0h6M7 18h1m3-12h6m-3-3 3 3-3 3",
  ...
  "webhook-in": "M7 7a3 3 0 1 1 3 3l-3 6a3 3 0 1 0 3 4m7-3a3 3 0 1 1-3-3l3-6a3 3 0 1 0-3-4m-1 8h-6m3-3-3 3 3 3",
  "webhook-out": "M7 7a3 3 0 1 1 3 3l-3 6a3 3 0 1 0 3 4m7-3a3 3 0 1 1-3-3l3-6a3 3 0 1 0-3-4m-4 8h6m-3-3 3 3-3 3",
